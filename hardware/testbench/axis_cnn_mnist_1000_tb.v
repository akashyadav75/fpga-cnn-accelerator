...
module axis_cnn_mnist_1000_tb();
    ...
    initial
    begin
                                // input_1000.txt uses space-separated hex values which $readmemh
        // handles correctly (whitespace = separator, not line boundary).
        $readmemh("C:/temp/mnist_cnn_accelerator/hardware/testvector/input_1000.txt", pixels);
